                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" name="basic_validate" id="signupForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="title" placeholder="输入广告标题" class="form-control" value="{{old('title')}}"></div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">广告描述</label>
                                <div class="col-sm-6">
                                    <input type="text" name="desc"  placeholder="输入广告描述" class="form-control" value="{{old('desc')}}"></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="link" placeholder="输入广告链接" class="form-control" value="{{old('link')}}"></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="radio i-checks">
                                        <input type="radio" name='state' value="6" checked="checked" />
                                        开启
                                        <input type="radio" name='state' value="8" />
                                        关闭
                                    </div>
                                </div>
                            </div>
