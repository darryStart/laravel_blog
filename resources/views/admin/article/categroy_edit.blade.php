                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" id="signupForm" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="cate_name" placeholder="输入分类名称" class="form-control" value="{{$data->cate_name}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <a class="btn btn-danger" href="{{url('admin.article.category_list')}}">取消</a>
                                </div>
                            </div>
                        </form>
                    </div>
