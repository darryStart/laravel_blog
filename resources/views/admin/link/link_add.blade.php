                    ...
                    <ul class="list-group">
                        <li class="list-group-item">
                            <p class="text-success"><a href="{{route('admin_index')}}" title="返回首页" class="tip-bottom"><i class="fa fa-home"></i> 首页</a> /
                                <a href="{{route('link')}}" class="tip-bottom">网站管理</a>
                            </p>
                        </li>
                    </ul>
                </div>
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="link_name" class="form-control" value="{{old('link_name')}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio i-checks">
                                    <label>
                                        <input type="radio"  checked="checked" value="6" name="state"> <i></i> 开启</label>
                                    <label>
                                        <input type="radio" value="8" name="state"> <i></i> 关闭</label>
                                </div>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                ...
                                <a class="btn btn-danger" href="{{route('link_add')}}">取消</a>
                            </div>
                        </div>
                    </form>
                </div>
