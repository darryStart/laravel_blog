                                ...
                                <div class="said_img message">
                                    ...
                                    <div class="reply-div">
                                        ...
                                        <div class="express">
                                            ...
                                            <!--face end-->
                                            <button class="button bg-blue reply-sub" data-id="{{$v->say_id}}" data-name="{{$vv->reply_user_name}}" type="button">发表</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
//        });
//        $(document).on('click','.reply-sub',function(){
        $('.reply-sub').on('click',function(){
            ...
            if(_content == ''){
                ...
                $.ajax({
                    'url':"{{route('reply')}}",
                    'type':'post',
                    'data':{'content':_content,'be_reply_user_name':data_name,'say_id':say_id,'_token':"{{csrf_token()}}"},
                    success:function (msg) {
                        if(msg>0){
                            ...
                            str +=           '<span>回复 @<a>'; str += data_name; str += '</a> 中说到：</span>';
                            str +=       '</div>';
                            str +=       '<div class="liuyan_c">';
                            str +=           _content;
                            str +=           '<span title="回复" class="icon-comment reply-icon"></span>';
                            str +=       '</div>';
                            str +=       '<div class="reply-div">';
                            str +=       '<div class="say-content" contentEditable="true"></div>';
                            str +=       '<div class="express">';
                            str +=           '<img src="{{asset('static/face/bba_thumb.gif')}}" class="bq"/>';
                            str +=           '<div class="face">';
                            str +=               "<ul>";
                            str +=                    "<li><img src={{asset('static/face/zz2_thumb.gif')}} title='[织]' ></li>";
                            str +=                    "<li><img src={{asset('static/face/horse2_thumb.gif')}} title='神马]'></li>";
                            str +=                    "<li><img src={{asset('static/face/fuyun_thumb.gif')}} title='[浮云]'></li>";
                            str +=                    "<li><img src={{asset('static/face/geili_thumb.gif')}} title='[给力]'></li>";
                            str +=                    "<li><img src={{asset('static/face/wg_thumb.gif')}} title='[围观]'></li>";
                            str +=                    "<li><img src={{asset('static/face/vw_thumb.gif')}} title='[威武]'></li>";
                            str +=                    "<li><img src={{asset('static/face/panda_thumb.gif')}} title='[熊猫]'></li>";
                            str +=                    "<li><img src={{asset('static/face/rabbit_thumb.gif')}} title='兔子]'></li>";
                            str +=                    "<li><img src={{asset('static/face/otm_thumb.gif')}} title='[奥特曼]'></li>";
                            str +=                    "<li><img src={{asset('static/face/j_thumb.gif')}} title='[囧]'></li>";
                            str +=                    "<li><img src={{asset('static/face/hufen_thumb.gif')}} title='[互粉]'></li>";
                            str +=                    "<li><img src={{asset('static/face/liwu_thumb.gif')}} title='[礼物]'></li>";
                            str +=                    "<li><img src={{asset('static/face/smilea_thumb.gif')}} title='呵呵]'></li>";
                            str +=                    "<li><img src={{asset('static/face/tootha_thumb.gif')}} title='嘻嘻]'></li>";
                            str +=                    "<li><img src={{asset('static/face/laugh.gif')}} title='[哈哈]'></li>";
                            str +=                    "<li><img src={{asset('static/face/tza_thumb.gif')}} title='[可爱]'></li>";
                            str +=                    "<li><img src={{asset('static/face/kl_thumb.gif')}} title='[可怜]'></li>";
                            str +=                    "<li><img src={{asset('static/face/kbsa_thumb.gif')}} title='[挖鼻屎]'></li>";
                            str +=                    "<li><img src={{asset('static/face/cj_thumb.gif')}} title='[吃惊]'></li>";
                            str +=                    "<li><img src={{asset('static/face/shamea_thumb.gif')}} title='[害羞]'></li>";
                            str +=                    "<li><img src={{asset('static/face/zy_thumb.gif')}} title='[挤眼]'></li>";
                            str +=                    "<li><img src={{asset('static/face/bz_thumb.gif')}} title='[闭嘴]'></li>";
                            str +=                    "<li><img src={{asset('static/face/bs2_thumb.gif')}} title='[鄙视]'></li>";
                            str +=                    "<li><img src={{asset('static/face/lovea_thumb.gif')}} title='[爱你]'></li>";
                            str +=                    "<li><img src={{asset('static/face/sada_thumb.gif')}} title='[泪]'></li>";
                            str +=                    "<li><img src={{asset('static/face/heia_thumb.gif')}} title='[偷笑]'></li>";
                            str +=                    "<li><img src={{asset('static/face/qq_thumb.gif')}} title='[亲亲]'></li>";
                            str +=                    "<li><img src={{asset('static/face/sb_thumb.gif')}} title='[生病]'></li>";
                            str +=                    "<li><img src={{asset('static/face/mb_thumb.gif')}} title='[太开心]'></li>";
                            str +=                    "<li><img src={{asset('static/face/ldln_thumb.gif')}} title='[懒得理你]'></li>";
                            str +=                    "<li><img src={{asset('static/face/yhh_thumb.gif')}} title='[右哼哼]'></li>";
                            str +=                    "<li><img src={{asset('static/face/zhh_thumb.gif')}} title='[左哼哼]'></li>";
                            str +=                    "<li><img src={{asset('static/face/x_thumb.gif')}} title='[嘘]'></li>";
                            str +=                    "<li><img src={{asset('static/face/cry.gif')}} title='[衰]'></li>";
                            str +=                    "<li><img src={{asset('static/face/wq_thumb.gif')}} title='[委屈]'></li>";
                            str +=                    "<li><img src={{asset('static/face/t_thumb.gif')}} title='[吐]'></li>";
                            str +=                    "<li><img src={{asset('static/face/k_thumb.gif')}} title='[打哈气]'></li>";
                            str +=                    "<li><img src={{asset('static/face/bba_thumb.gif')}} title='[抱抱]'></li>";
                            str +=                    "<li><img src={{asset('static/face/angrya_thumb.gif')}} title='[怒]'></li>";
                            str +=                    "<li><img src={{asset('static/face/yw_thumb.gif')}} title='[疑问]'></li>";
                            str +=                    "<li><img src={{asset('static/face/cza_thumb.gif')}} title='[馋嘴]'></li>";
                            str +=                    "<li><img src={{asset('static/face/88_thumb.gif')}} title='[拜拜]'></li>";
                            str +=                    "<li><img src={{asset('static/face/sk_thumb.gif')}} title='[思考]'></li>";
                            str +=                    "<li><img src={{asset('static/face/sweata_thumb.gif')}} title='[汗]'></li>";
                            str +=                    "<li><img src={{asset('static/face/sleepya_thumb.gif')}} title='[困]'></li>";
                            str +=                    "<li><img src={{asset('static/face/sleepa_thumb.gif')}} title='[睡觉]'></li>";
                            str +=                    "<li><img src={{asset('static/face/money_thumb.gif')}} title='[钱]'></li>";
                            str +=                    "<li><img src={{asset('static/face/sw_thumb.gif')}} title='[失望]'></li>";
                            str +=                    "<li><img src={{asset('static/face/cool_thumb.gif')}} title='[酷]'></li>";
                            str +=                    "<li><img src={{asset('static/face/hsa_thumb.gif')}} title='[花心]'></li>";
                            str +=                    "<li><img src={{asset('static/face/hatea_thumb.gif')}} title='[哼]'></li>";
                            str +=                    "<li><img src={{asset('static/face/gza_thumb.gif')}} title='[鼓掌]'></li>";
                            str +=                    "<li><img src={{asset('static/face/dizzya_thumb.gif')}} title='[晕]'></li>";
                            str +=                    "<li><img src={{asset('static/face/bs_thumb.gif')}} title='[悲伤]'></li>";
                            str +=                    "<li><img src={{asset('static/face/crazya_thumb.gif')}} title='[抓狂]'></li>";
                            str +=                    "<li><img src={{asset('static/face/h_thumb.gif')}} title='[黑线]'></li>";
                            str +=                    "<li><img src={{asset('static/face/yx_thumb.gif')}} title='[阴险]'></li>";
                            str +=                    "<li><img src={{asset('static/face/nm_thumb.gif')}} title='[怒骂]'></li>";
                            str +=                    "<li><img src={{asset('static/face/hearta_thumb.gif')}} title='[心]'></li>";
                            str +=                    "<li><img src={{asset('static/face/unheart.gif')}} title='[伤心]'></li>";
                            str +=                    "<li><img src={{asset('static/face/pig.gif')}} title='[猪头]'></li>";
                            str +=                    "<li><img src={{asset('static/face/ok_thumb.gif')}} title='[ok]'></li>";
                            str +=                    "<li><img src={{asset('static/face/ye_thumb.gif')}} title='[耶]'></li>";
                            str +=                    "<li><img src={{asset('static/face/good_thumb.gif')}} title='[good]'></li>";
                            str +=                    "<li><img src={{asset('static/face/no_thumb.gif')}} title='[不要]'></li>";
                            str +=                    "<li><img src={{asset('static/face/z2_thumb.gif')}} title='[赞]'></li>";
                            str +=                    "<li><img src={{asset('static/face/come_thumb.gif')}} title='[来]'></li>";
                            str +=                    "<li><img src={{asset('static/face/sad_thumb.gif')}} title='[弱]'></li>";
                            str +=                    "<li><img src={{asset('static/face/lazu_thumb.gif')}} title='[蜡烛]'></li>";
                            str +=                    "<li><img src={{asset('static/face/clock_thumb.gif')}} title='[钟]'></li>";
                            str +=                    "<li><img src={{asset('static/face/cake.gif')}} title='[蛋糕]'></li>";
                            str +=                    "<li><img src={{asset('static/face/m_thumb.gif')}} title='[话筒]'></li>";
                            str +=                    "<li><img src={{asset('static/face/weijin_thumb.gif')}} title='[围脖]'></li>";
                            str +=                    "<li><img src={{asset('static/face/lxhzhuanfa_thumb.gif')}} title='[转发]'></li>";
                            str +=                    "<li><img src={{asset('static/face/lxhluguo_thumb.gif')}} title='[路过这儿]'></li>";
                            str +=                    "<li><img src={{asset('static/face/bofubianlian_thumb.gif')}} title='[bofu变脸]'></li>";
                            str +=                    "<li><img src={{asset('static/face/gbzkun_thumb.gif')}} title='[gbz困]'></li>";
                            str +=                    "<li><img src={{asset('static/face/boboshengmenqi_thumb.gif')}} title='[生闷气]'></li>";
                            str +=                    "<li><img src={{asset('static/face/chn_buyaoya_thumb.gif')}} title='[不要啊]'></li>";
                            str +=                    "<li><img src={{asset('static/face/daxiongleibenxiong_thumb.gif')}} title='[dx泪奔]'></li>";
                            str +=                    "<li><img src={{asset('static/face/cat_yunqizhong_thumb.gif')}} title='[运气中]'></li>";
                            str +=                    "<li><img src={{asset('static/face/youqian_thumb.gif')}} title='[有钱]'></li>";
                            str +=                    "<li><img src={{asset('static/face/cf_thumb.gif')}} title='[冲锋]'></li>";
                            str +=                    "<li><img src={{asset('static/face/camera_thumb.gif')}} title='[照相机]'></li>";
                            str +=              '</ul>';
                            str +=         '</div>';
                            str +=         '<button class="button bg-blue reply-sub" data-id="'; str += say_id; str +='" data-name="'; str += data_name; str += '" type="button">发表</button>';
                            str +=       '</div></div></div>';
                            $('.say-content').html('');
