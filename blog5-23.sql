...
#
# Structure for table "web_failed_jobs"
#
...
#
# Data for table "web_failed_jobs"
#
...
CREATE TABLE `web_link` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='友情连接表';
...
INSERT INTO `web_link` VALUES (1,'轮回博客','http://www.tianjianlong.com.cn',6,1430238360,1494301085,21),(17,'Thinkphp','http://www.thinkphp.cn/',6,1494298677,1494298677,1),(25,'不知道','https://github.com/darryStart/laravel_blog',8,1494328479,1494328479,100);
/*!40000 ALTER TABLE `web_link` ENABLE KEYS */;

#
# Structure for table "web_message"
#
...
CREATE TABLE `web_message` (
  ...
  `c_photo` varchar(255) DEFAULT NULL COMMENT '回复头像',
...
#
# Data for table "web_message"
#

/*!40000 ALTER TABLE `web_message` DISABLE KEYS */;
INSERT INTO `web_message` VALUES (11,1451828736,'114.117.190.189','博主网站很漂亮，希望加个友链','破晓起飞','/static/home/images/Portrait/47.jpg','Win 7','dawnflyingnow@qq.com','uploads/userimg/2015-11-23/5653291eed25d.jpg','轮回','好的，链接和名称是什么呢',1451829515),(29,1495522092,'成都','发表第一条留言','admin-darry','http://localhost/static/home/images/Portrait/16.jpg','Windows 7','2423424234@163.com',NULL,'','',NULL),(30,1495522141,'成都','发表第二条留言','admin-darry','http://localhost/static/home/images/Portrait/16.jpg','Windows 7','123213@163.com',NULL,'','',NULL),(31,1495522230,'成都','21313111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111','admin-darry','http://localhost/static/home/images/Portrait/16.jpg','Windows 7','132131@126.com',NULL,'','',NULL);
/*!40000 ALTER TABLE `web_message` ENABLE KEYS */;

#
# Structure for table "web_migrations"
#

DROP TABLE IF EXISTS `web_migrations`;
...
#
# Data for table "web_migrations"
#

/*!40000 ALTER TABLE `web_migrations` DISABLE KEYS */;
INSERT INTO `web_migrations` VALUES ('2017_05_12_153322_create_jobs_table',1),('2017_05_12_153329_create_failed_jobs_table',1);
...
#
# Structure for table "web_reply"
#

DROP TABLE IF EXISTS `web_reply`;
CREATE TABLE `web_reply` (
  `reply_id` int(11) NOT NULL AUTO_INCREMENT,
  `say_id` int(11) unsigned DEFAULT NULL COMMENT '说说id',
  `content` mediumtext COMMENT '回复内容',
  `reply_user_name` varchar(64) DEFAULT NULL COMMENT '回复用户昵称',
  `reply_user_face` varchar(255) DEFAULT NULL COMMENT '回复用户头像',
  `be_reply_user_name` varchar(64) DEFAULT NULL COMMENT '被回复用户昵称',
  `create_time` int(11) unsigned DEFAULT NULL COMMENT '回复时间',
  PRIMARY KEY (`reply_id`)
) ENGINE=MyISAM AUTO_INCREMENT=83 DEFAULT CHARSET=utf8;

#
# Data for table "web_reply"
#

/*!40000 ALTER TABLE `web_reply` DISABLE KEYS */;
/*!40000 ALTER TABLE `web_reply` ENABLE KEYS */;
...
#
# Structure for table "web_say"
#

DROP TABLE IF EXISTS `web_say`;
CREATE TABLE `web_say` (
  `say_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '说说逻辑排序',
  `say_content` text NOT NULL COMMENT '说说内容',
  `user_name` varchar(32) NOT NULL DEFAULT '' COMMENT '说说作者',
  `user_face` varchar(255) DEFAULT NULL COMMENT '说说头像',
  `state` tinyint(1) unsigned NOT NULL DEFAULT '6' COMMENT '说说的显推 6 显示 8 不显示',
  `create_city` varchar(16) NOT NULL DEFAULT '' COMMENT '说说地址',
  `create_os` varchar(32) DEFAULT NULL COMMENT '说说系统',
  `create_time` int(10) NOT NULL COMMENT '说说发表时间',
  `reply_num` smallint(2) unsigned DEFAULT '0' COMMENT '说说回复条数',
  PRIMARY KEY (`say_id`),
  KEY `say_id` (`say_id`)
) ENGINE=MyISAM AUTO_INCREMENT=94 DEFAULT CHARSET=utf8 COMMENT='说说表';

#
# Data for table "web_say"
#

/*!40000 ALTER TABLE `web_say` DISABLE KEYS */;
INSERT INTO `web_say` VALUES (90,'再来一条','admin-darry','http://localhost/static/home/images/Portrait/16.jpg',8,'成都','Windows 7',1495076726,0),(91,'第一条说说从现在开始，let go','admin-darry','http://localhost/static/home/images/Portrait/16.jpg',6,'成都','Windows 7',1495076799,0),(93,'1、简介 Laravel 提供了多个有用的工具让测试数据库驱动的应用变得更加简单。首先，你可以使用辅助函数 assertDatabaseHas 来断言数据库中的数据是否和给定数据集合匹配。例如，如果你想要通过 email 值为sally@example.com 的条件去数据表users 查询是否存在该记录 ，我们可以这样做： public function testDatabas','admin-darry','http://localhost/static/home/images/Portrait/16.jpg',8,'成都','Windows 7',1495529204,213);
/*!40000 ALTER TABLE `web_say` ENABLE KEYS */;
...
CREATE TABLE `web_user` (
  ...
  `user_key` varchar(255) DEFAULT NULL COMMENT '用户唯一表示',
  `create_time` int(11) unsigned DEFAULT NULL COMMENT '第一次登陆时间',
  `login_num` smallint(5) unsigned DEFAULT '1' COMMENT '登陆次数',
  PRIMARY KEY (`user_id`)
