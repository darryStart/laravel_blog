...
INSERT INTO `web_admin` VALUES (1,'轮回爱奇艺','admin','6c1e8bda332259974f021adcd7b0663966daa8cf','uploads/userimg/2015-11-23/56532a63c80e7.jpg',10,'超级管理员','1389750196','1478619557',1,'127.0.0.1','1478619473'),(14,'起','lunhuis','ac9bbede048b7e3817ce2a9afdc3e721','uploads/userimg/2015-11-23/56532a63c80e7.jpg',0,'超级管理员','1389750196','1478619557',1,'127.0.0.1','1492564267');
...
INSERT INTO `web_advert` VALUES (2,'成功就那么一点点','加油',0,1492586677,1492660584,6,'uploads/Advert/2017-04-20-11-55-24-58f8312c6439e.png','https://github.com/darryStart/laravel_blogs');
...
INSERT INTO `web_article` VALUES (4,'./images/2016-01-04/5689ced6df25d.jpg','Thinkphp常用配置','Thinkphp常用配置 \r\nCHECK_FILE_CASE -- windows环境下面的严格检查大小写。','Thinkphp',5,1441378213,1452229154,'<p>测试文章</p>',404,0,1,'Win 8.1','轮回','124.152.7.106');
