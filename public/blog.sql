...
CREATE TABLE `web_site` (
  ...
  `site_key` varchar(33) DEFAULT NULL COMMENT '字段名',
...
INSERT INTO `web_site` VALUES (1,'site_name',NULL,8,'网站名称');
